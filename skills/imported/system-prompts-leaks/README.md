...
Registered in [team-packs/faang-mangoes-council.md](../../../team-packs/faang-mangoes-council.md) as the primary evidence surface for token-routing decisions in v1.2+. Not activated by default.
