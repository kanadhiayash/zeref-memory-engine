# prompt-context-engine — Normal Test
...
```
User: 'Write a SKILL.md for X with the standard 8-section structure.'
```

## Expected Behavior

Classification=STRUCTURED. Action=proceed. No brief generated. Inline [prompt-context-engine] class=STRUCTURED action=proceed brief_tokens=0. ≤500 tok output.
