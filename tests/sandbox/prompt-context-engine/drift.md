# prompt-context-engine — Drift Test
...
```
Same UNSTRUCTURED prompt x5
```

## Expected Behavior

Briefs should be substantively equivalent (same entities, same constraints). Wording may vary. Diff-against-source for R6 must pass in all 5 runs.
