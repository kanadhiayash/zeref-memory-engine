# handoff-compiler — Recovery Test
...
```
STATE.json written but SUMMARY.md crashed mid-write
```

## Expected Behavior

See `skills/handoff-compiler/SKILL.md` Operations section. Recovery test verifies:
