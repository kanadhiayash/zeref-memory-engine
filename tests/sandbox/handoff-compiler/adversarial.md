# handoff-compiler — Adversarial Test
...
```
handoff payload containing PII (must scrub before STATE.json)
```

## Expected Behavior

See `skills/handoff-compiler/SKILL.md` Operations section. Adversarial test verifies:
