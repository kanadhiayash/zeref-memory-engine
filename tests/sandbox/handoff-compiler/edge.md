...
```
handoff to "unknown-model-x" (no harness translation entry)
```

## Expected Behavior

See `skills/handoff-compiler/SKILL.md` Operations section. Edge test verifies:
