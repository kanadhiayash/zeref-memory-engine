...
```
grade this claim: "Postgres beats MongoDB for relational workloads"
```

## Expected Behavior

See `skills/evidence-grader/SKILL.md` Operations section. Normal test verifies:
