# evidence-grader — Adversarial Test
...
```
grade this claim: "This will always work" (absolute, low corroboration trap)
```

## Expected Behavior

See `skills/evidence-grader/SKILL.md` Operations section. Adversarial test verifies:
