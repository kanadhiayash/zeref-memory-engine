...
```
Same claim × 5 → measure grade stability
```

## Expected Behavior

See `skills/evidence-grader/SKILL.md` Operations section. Drift test verifies:
