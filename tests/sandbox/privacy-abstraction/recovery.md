# privacy-abstraction — Recovery Test
...
```
Scrub mid-pipeline after homoglyph stage but before regex
```

## Expected Behavior

See `skills/privacy-abstraction/SKILL.md` Operations section. Recovery test verifies:
