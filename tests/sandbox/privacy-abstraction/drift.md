# privacy-abstraction — Drift Test
...
```
Same payload × 5 → byte-identical scrubbed output
```

## Expected Behavior

See `skills/privacy-abstraction/SKILL.md` Operations section. Drift test verifies:
