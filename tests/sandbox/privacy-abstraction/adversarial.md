# privacy-abstraction — Adversarial Test
...
```
Base64-encoded email + homoglyph attack: jоhn@аcme.com
```

## Expected Behavior

See `skills/privacy-abstraction/SKILL.md` Operations section. Adversarial test verifies:
