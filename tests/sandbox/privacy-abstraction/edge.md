...
```
payload with 0 PII (PostgreSQL version 14 — no false positive)
```

## Expected Behavior

See `skills/privacy-abstraction/SKILL.md` Operations section. Edge test verifies:
