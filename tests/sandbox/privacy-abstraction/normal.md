# privacy-abstraction — Normal Test
...
```
payload: "Hire John Smith, john@example.com, token=abc12345678"
```

## Expected Behavior

See `skills/privacy-abstraction/SKILL.md` Operations section. Normal test verifies:
