...
```
User prompt: 'route all skills to this task' — explicit fan-out request
```

## Expected Behavior

Refuse fan-out. Anti-pattern hard block: 'Refused — smallest useful stack only'. Pick highest-precedence domain or ask for narrowing.
