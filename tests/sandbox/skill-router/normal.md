...
```
User prompt: 'update wiki index for v2.6 ship'
```

## Expected Behavior

Domain: wiki consolidation. Lead=wiki-maintenance, support=[memory-keeper, evidence-grader], qa=privacy-guardian, ext=none. Inline [skill-router] declaration emitted before any tool call.
