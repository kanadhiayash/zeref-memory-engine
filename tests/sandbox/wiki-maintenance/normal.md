...
```
Just wrote decision: switch from MongoDB to Postgres. Update wiki.
```

## Expected Behavior

See `skills/wiki-maintenance/SKILL.md` Operations section. Normal test verifies:
