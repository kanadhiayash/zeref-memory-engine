...
```
(empty memory/index.md, 50+ existing decisions, 3 stale >90 days)
```

## Expected Behavior

See `skills/wiki-maintenance/SKILL.md` Operations section. Edge test verifies:
