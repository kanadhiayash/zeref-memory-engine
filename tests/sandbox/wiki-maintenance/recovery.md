# wiki-maintenance — Recovery Test
...
```
Mid-consolidation crash after merging duplicates but before archive move. Resume.
```

## Expected Behavior

See `skills/wiki-maintenance/SKILL.md` Operations section. Recovery test verifies:
