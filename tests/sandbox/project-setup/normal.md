...
```
set up project (no config/PROJECT.md present)
```

## Expected Behavior

See `skills/project-setup/SKILL.md` Operations section. Normal test verifies:
