...
```
set up project × 5 (should be idempotent if already configured)
```

## Expected Behavior

See `skills/project-setup/SKILL.md` Operations section. Drift test verifies:
