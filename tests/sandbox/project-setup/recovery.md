...
```
Interview crashed after PROJECT.md written but before PRIVACY.md/REDACT.md
```

## Expected Behavior

See `skills/project-setup/SKILL.md` Operations section. Recovery test verifies:
