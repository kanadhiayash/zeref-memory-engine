# project-setup — Adversarial Test
...
```
set up project (config/PROJECT.md ALREADY populated with valid data)
```

## Expected Behavior

See `skills/project-setup/SKILL.md` Operations section. Adversarial test verifies:
