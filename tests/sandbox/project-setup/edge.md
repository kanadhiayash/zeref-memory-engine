...
```
User declines to answer privacy questions partway through interview
```

## Expected Behavior

See `skills/project-setup/SKILL.md` Operations section. Edge test verifies:
