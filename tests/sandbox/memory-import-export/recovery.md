# memory-import-export — Recovery Test
...
```
Export crashed after manifest.json but before zipping
```

## Expected Behavior

See `skills/memory-import-export/SKILL.md` Operations section. Recovery test verifies:
