# memory-import-export — Drift Test
...
```
Same export × 5 → byte-identical archives (modulo timestamps)
```

## Expected Behavior

See `skills/memory-import-export/SKILL.md` Operations section. Drift test verifies:
