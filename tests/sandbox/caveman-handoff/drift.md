...
```
Same handoff package x5 runs
```

## Expected Behavior

Compression ratio within ±3% across runs. Entity preservation identical (Set membership). Inline report line identical except for ts.
