...
```
Probe same 6 tools x5 runs in 1 second
```

## Expected Behavior

Re-probe each invocation (no cache). All 5 runs identical reachability output unless filesystem changed mid-run.
