...
```
/sync-parent with config/PARENT_SYNC.md enabled:true and valid parent_path
```

## Expected Behavior

See `skills/parent-sync/SKILL.md` Operations section. Normal test verifies:
