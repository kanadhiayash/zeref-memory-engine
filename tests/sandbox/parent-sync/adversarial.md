...
```
Outbound staged content contains PII (must be filtered before push)
```

## Expected Behavior

See `skills/parent-sync/SKILL.md` Operations section. Adversarial test verifies:
