# contradiction-resolution — Normal Test
...
```
Write conflicting claim: "use SQLite" when DECISIONS.md says "use Postgres"
```

## Expected Behavior

See `skills/contradiction-resolution/SKILL.md` Operations section. Normal test verifies:
