# contradiction-resolution — Edge Test
...
```
CONFLICTS.md has 20 stale unresolved conflicts; new conflict added
```

## Expected Behavior

See `skills/contradiction-resolution/SKILL.md` Operations section. Edge test verifies:
