# contradiction-resolution — Recovery Test
...
```
Conflict detected, queued, but DECISIONS.md write completed anyway
```

## Expected Behavior

See `skills/contradiction-resolution/SKILL.md` Operations section. Recovery test verifies:
