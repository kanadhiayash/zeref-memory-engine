# contradiction-resolution — Drift Test
...
```
Same contradiction × 5 → verify same surfacing, no silent merge
```

## Expected Behavior

See `skills/contradiction-resolution/SKILL.md` Operations section. Drift test verifies:
