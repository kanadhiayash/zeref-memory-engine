# contradiction-resolution — Adversarial Test
...
```
Two semantically identical but lexically different decisions (paraphrase)
```

## Expected Behavior

See `skills/contradiction-resolution/SKILL.md` Operations section. Adversarial test verifies:
