...
```
PATTERNS.jsonl has 5 identical events; pattern-observer threshold hit
```

## Expected Behavior

See `skills/pattern-to-skill/SKILL.md` Operations section. Normal test verifies:
