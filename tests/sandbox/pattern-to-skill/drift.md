...
```
Same pattern × 5 → same draft (idempotent) or distinct (depends on spec)
```

## Expected Behavior

See `skills/pattern-to-skill/SKILL.md` Operations section. Drift test verifies:
