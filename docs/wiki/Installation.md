...
Zeref v1.1.0 installs as a Claude Code plugin. Other harnesses (Cursor, Aider, Windsurf, Gemini, Codex, Llama-family) read AGENTS.md directly via per-harness stubs.
...
# zeref-os@zeref-os  v1.1.0  enabled
